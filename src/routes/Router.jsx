...
import AcademicSchedule from '../pages/academic-info/AcademicSchedule/AcademicSchedule';
import RequiredCourses from '../pages/academic-info/RequiredCourses/RequiredCourses';
import ApplyTips from '../pages/academic-info/ApplyTips/ApplyTips';

import MajorOverview from '../pages/lecture-info/MajorOverview/MajorOverview';
import Professors from '../pages/lecture-info/Professors/Professors';
import ProfessorEvaluations from '../pages/lecture-info/ProfessorEvaluations/ProfessorEvaluations';
import PopularElectives from '../pages/lecture-info/PopularElectives/PopularElectives';
import RecommendedElectives from '../pages/lecture-info/RecommendedElectives/RecommendedElectives';
import LectureTips from '../pages/lecture-info/LectureTips/LectureTips';

import ClassroomNumberGuide from '../pages/campus-facilities/ClassroomNumberGuide/ClassroomNumberGuide';
import CollegeLocations from '../pages/campus-facilities/College-locations/College-locations';
import ConvenienceInfo from '../pages/campus-facilities/Convenience-info/Convenience-info';
import OfficeLocations from '../pages/campus-facilities/Office-locations/Office-locations';
import SmokingAreas from '../pages/campus-facilities/Smoking-areas/Smoking-areas';
import ParkingInfo from '../pages/campus-facilities/Parking-info/Parking-info';

import CampusCafeteriaIntro from '../pages/campus-cafeteria/CampusCafeteriaIntro/CampusCafeteriaIntro';
import CampusCafeteriaMenu from '../pages/campus-cafeteria/CampusCafeteriaMenu/CampusCafeteriaMenu';
